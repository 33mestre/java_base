...
public class CurrencyConversionRouteTest {
    ...
    public void testCurrencyConversionRoute() throws Exception {
        ...
        assertEquals("USD", result.getSourceCurrency().getCode(), "The source currency should be USD");
        assertEquals("EUR", result.getTargetCurrency().getCode(), "The target currency should be EUR");
